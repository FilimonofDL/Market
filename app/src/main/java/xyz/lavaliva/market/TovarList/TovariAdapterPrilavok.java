...
public class TovariAdapterPrilavok extends RecyclerView.Adapter<TovariAdapterPrilavok.TovarViewHolder> {
    ...
    int lastVisibleItem;
    int totalItemCount;
    //    public static String ID_TOVARA_OTKRITOGO;
    public  static  TovariObjPrilavok tovariObjPrilavokStatic;


    public TovariAdapterPrilavok(RecyclerView recyclerView, Activity activity,
    ...
    class TovarViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final TovariObjPrilavok tovariObjPrilavok) {
            ...
            tvNaimenovanie.setText(tovariObjPrilavok.getId()+" "+tovariObjPrilavok.getNaimenovanie());
